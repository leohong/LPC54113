 ...
 * @return	 Nothing
 */
STATIC INLINE void Chip_SSP_Int_Enable(LPC_SSP_T *pSSP, SSP_INTMASK_T IntMsk)
{
	pSSP->IMSC |= IntMsk;
}
 ...
 * @return	 Nothing
 */
STATIC INLINE void Chip_SSP_Int_Disable(LPC_SSP_T *pSSP, SSP_INTMASK_T IntMsk)
{
	pSSP->IMSC &= (~IntMsk) & SSP_INT_MASK_BITMASK;;
}
