...
extern void SPI_EARSE(void) ;
extern void SPI_WRITE_TEST(unsigned int WRITE_ADDRESS, unsigned int WRITE_4K_SIZE) ;
extern void SPI_WRITE(unsigned int WRITE_ADDRESS) ;
extern void SPI_READ(unsigned int READ_ADDRESS) ;
/**
 * @}
 */
