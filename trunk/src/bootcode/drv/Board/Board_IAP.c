...
static const char *m_apIAP_String[] =
{
    ...
    #define IAP_LOG LOG_MSG
#else
    #define IAP_LOG(mask, fmt, arg...)
#endif /* __IAP_DEBUG__ */
...
// --------------------
// ==============================================================================
eRESULT Board_IAP_Initial(void)
{
...
// --------------------
// ==============================================================================
eRESULT Board_IAP_Erase(DWORD dwAddress, DWORD dwSize)
{
    ...
    return (cResult == 0 ? rcSUCCESS : rcERROR);
}
...
// --------------------
// ==============================================================================
eRESULT Board_IAP_Write(DWORD dwAddress, DWORD dwSize, BYTE *pcData)
{
    sFLASH_INFO sFlashInfo;
    BYTE cResult = 0;

    IAP_LOG(eDB_MSK_LIST_IAP, "Write\r\n");
    IAP_LOG(eDB_MSK_LIST_IAP, "Address = 0x%02X, Size=%d\r\n", dwAddress, dwSize);
...
// --------------------
// ==============================================================================
eRESULT Board_IAP_PageErase(DWORD dwAddress, DWORD dwSize)
{
    sFLASH_INFO sFlashInfo;
    DWORD cResult = 0;

    IAP_LOG(eDB_MSK_LIST_IAP, "Erase\r\n");
    IAP_LOG(eDB_MSK_LIST_IAP, "Address = 0x%02X\r\n", dwAddress);
