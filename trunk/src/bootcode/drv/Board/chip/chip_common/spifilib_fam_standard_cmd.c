 ...
 * S25FL164K<br>
 * S25FL256S (untested)<br>
 * S25FL512S (untested)<br>
 * MX25L1635E<br>
 * MX25L3235E<br>
 * MX25L6435E<br>
 * MX25L8035E<br>
...
#define SPIFI_DEVICE_MX25L6435E         1		/**< Enables Macronix MX25L6435E device */
...
#define SPIFI_DEVICE_W25Q256FV          0		/**< Enables Winbond W25Q32V device */
#define SPIFI_DEVICE_W25Q80BV           0		/**< Enables Winbond W25Q80BV device */
#define SPIFI_DEVICE_MX66L51235F        1		/**< Enables Winbond MX66L51235F device */
#define SPIFI_DEVICE_MX25L25635E        1       /**< Enables Winbond MX25L25635E device */
...
#define CMD_D8_SE                   0xD8		/**< 64KB Sector Erase */
...
void spifiDeviceInitReadCommand(const SPIFI_HANDLE_T *pHandle, uint8_t enable,
...
void spifiDeviceInitWriteCommand(const SPIFI_HANDLE_T *pHandle, uint32_t *cmd)
{
...
void spifiDeviceInitWriteCommandMacronix(const SPIFI_HANDLE_T *pHandle, uint32_t *cmd)
{
	if (pHandle->pInfoData->opts & SPIFI_CAP_QUAD_WRITE) {
...
SPIFI_FAM_NODE_T *spifi_REG_FAMILY_CommonCommandSet(void)
{
	...
	#endif
	#if SPIFI_DEVICE_ALL || SPIFI_DEVICE_W25Q256FV
	/* Add support for W25Q256FV 20170730*/
	{
		static const SPIFI_DEVICE_DATA_T pData = {
			"W25Q256FV",
			{{0xEF, 0x40, 0x16}, 0, {0}},	/* JEDEC ID, extCount?, ext data  */
	...
	/* Add support for S25FL256S 256K Sector */
	{
		static const SPIFI_DEVICE_DATA_T pData = {
			"S25FL256S 256kSec",
			{{0x01, 0x20, 0x19}, 2, {0x4D, 0x0}},	/* JEDEC ID, extCount, ext data  */
			(SPIFI_CAP_DUAL_READ | SPIFI_CAP_QUAD_READ | SPIFI_CAP_QUAD_WRITE | SPIFI_CAP_FULLLOCK | SPIFI_CAP_NOBLOCK),
			128,						/* # of blocks */
			0x40000,				/* block size */
			0,						/* # of sub-blocks (Does NOT support sub-block erase) */
	...
	/* Add support for S25FL256S 64k sector */
	{
		static const SPIFI_DEVICE_DATA_T pData = {
			"S25FL256S 64kSec",
			{{0x01, 0x20, 0x19}, 2, {0x4D, 0x01}},	/* JEDEC ID, extCount, ext data  */
			(SPIFI_CAP_DUAL_READ | SPIFI_CAP_QUAD_READ | SPIFI_CAP_QUAD_WRITE | SPIFI_CAP_FULLLOCK | SPIFI_CAP_NOBLOCK),
			512,					/* # of blocks */
			0x10000,				/* block size */
	...
	/* Add support for S25FL016K */
	{
		static const SPIFI_DEVICE_DATA_T pData = {
			...
			32,						/* # of blocks */
			0x10000,				/* block size */
			512,					/* # of sub-blocks  32 (This device only has sub-block erase in first/last 2 blocks) */
	...
	#endif
	#if SPIFI_DEVICE_ALL || SPIFI_DEVICE_MX25L25635E
	/* Add support for MX25L25635E 20170730 */
	{
		static const SPIFI_DEVICE_DATA_T pData = {
			"MX25L25635E",
			{{0xC2, 0x20, 0x19}, 0, {0}},	/* JEDEC ID, extCount, ext data  */
			(SPIFI_CAP_4BYTE_ADDR | SPIFI_CAP_DUAL_READ | SPIFI_CAP_QUAD_READ | SPIFI_CAP_QUAD_WRITE | SPIFI_CAP_NOBLOCK |
			 SPIFI_CAP_SUBBLKERASE),																						/* capabilities */
			512,						/* # of blocks */
			0x10000,				/* block size */
			8192,					/* # of sub-blocks */
			...
			133,				/* max read clock rate in MHz */
    ...
    #if SPIFI_DEVICE_ALL || SPIFI_DEVICE_MX66L51235F
    /* Add support for MX25L25635E 20170730 */
    {
        static const SPIFI_DEVICE_DATA_T pData = {
            "MX66L51235F",
            {{0xC2, 0x20, 0x1A}, 0, {0}},   /* JEDEC ID, extCount, ext data  */
            (SPIFI_CAP_4BYTE_ADDR | SPIFI_CAP_DUAL_READ | SPIFI_CAP_QUAD_READ | SPIFI_CAP_QUAD_WRITE | SPIFI_CAP_NOBLOCK |
             SPIFI_CAP_SUBBLKERASE),                                                                                        /* capabilities */
            0x400,                  /* # of blocks */
            0x10000,                /* block size */
            0x4000,                 /* # of sub-blocks */
            0x1000,                 /* sub-block size */
            0x100,                  /* page size */
            MAX_SINGLE_READ,        /* max single read bytes */
            133,                /* max clock rate in MHz */
